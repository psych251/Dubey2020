...
```{r, echo=FALSE,out.width="32%",out.height="30%",fig.cap="Original Study Plot - Pilot A Plot- Pilot B Plot",fig.show='hold',fig.align='center'}

knitr::include_graphics(c("images/original_plot.png","images/PilotA_phase2.png","images/PilotB_phase2.png"))
``` 


```{r, echo=FALSE,out.width="49%",out.height="20%",fig.cap="Original Significance Test Result - Pilot B Result",fig.show='hold',fig.align='center'}
